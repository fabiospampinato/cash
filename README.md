...
Get Cash from [CloudFlare](https://cdnjs.cloudflare.com/ajax/libs/cash/6.0.2/cash.min.js) or [jsDelivr](https://cdn.jsdelivr.net/npm/cash-dom@6.0.2/dist/cash.min.js) and use it like this:
