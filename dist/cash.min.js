...
function pa(a,b){b=a.dataset?a.dataset[b]||a.dataset[D(b)]:a.getAttribute("data-"+b);try{return a.dataset?b:JSON.parse(b)}catch(c){}return b}var qa=/^data-(.+)/;
y.prototype.data=function(a,b){var c=this;if(!a){if(!this[0])return;var d={};E(this[0].attributes,function(a,b){(a=b.name.match(qa))&&(d[a[1]]=c.data(a[1]))});return d}if(z(a))return void 0===b?this[0]&&pa(this[0],a):this.each(function(c,d){c=b;if(d.dataset)d.dataset[D(a)]=c;else{try{c=JSON.stringify(c)}catch(w){}d.setAttribute("data-"+a,c)}});for(var f in a)this.data(f,a[f]);return this};
