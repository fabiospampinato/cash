...
I.css=function(a,b){if(G(a)){var c=ya.test(a);a=Ca(a,c);if(2>arguments.length)return this[0]&&T(this[0],a,c);if(!a)return this;b=Ea(a,b,c);return this.each(function(f,g){C(g)&&(c?g.style.setProperty(a,b):g.style[a]=b)})}for(var d in a)this.css(d,a[d]);return this};var Fa=/^\s+|\s+$/,Ga=/e[+-]?\d+$/;function Ha(a,b){a=a.dataset[b]||a.dataset[K(b)];return Fa.test(a)||Ga.test(a)?a:ba(JSON.parse,a)}
I.data=function(a,b){if(!a){if(!this[0])return;var c={},d;for(d in this[0].dataset)c[d]=Ha(this[0],d);return c}if(G(a))return 2>arguments.length?this[0]&&Ha(this[0],a):void 0===b?this:this.each(function(f,g){f=b;f=ba(JSON.stringify,f);g.dataset[K(a)]=f});for(d in a)this.data(d,a[d]);return this};function Ia(a,b){var c=a.documentElement;return Math.max(a.body["scroll".concat(b)],c["scroll".concat(b)],a.body["offset".concat(b)],c["offset".concat(b)],c["client".concat(b)])}
function Ja(a,b){return V(a,"border".concat(b?"Left":"Top","Width"))+V(a,"padding".concat(b?"Left":"Top"))+V(a,"padding".concat(b?"Right":"Bottom"))+V(a,"border".concat(b?"Right":"Bottom","Width"))}
M([!0,!1],function(a,b){M(["Width","Height"],function(c,d){var f="".concat(b?"outer":"inner").concat(d);I[f]=function(g){if(this[0])return L(this[0])?b?this[0]["inner".concat(d)]:this[0].document.documentElement["client".concat(d)]:B(this[0])?Ia(this[0],d):this[0]["".concat(b?"offset":"client").concat(d)]+(g&&b?V(this[0],"margin".concat(c?"Top":"Left"))+V(this[0],"margin".concat(c?"Bottom":"Right")):0)}})});
M(["Width","Height"],function(a,b){var c=b.toLowerCase();I[c]=function(d){if(!this[0])return void 0===d?void 0:this;if(!arguments.length)return L(this[0])?this[0].document.documentElement["client".concat(b)]:B(this[0])?Ia(this[0],b):this[0].getBoundingClientRect()[c]-Ja(this[0],!a);var f=parseInt(d,10);return this.each(function(g,h){C(h)&&(g=T(h,"boxSizing"),h.style[c]=Ea(c,f+("border-box"===g?Ja(h,!a):0)))})}});var Ka={};
I.toggle=function(a){return this.each(function(b,c){if(C(c))if(void 0===a?"none"===T(c,"display"):a){if(c.style.display=c.___cd||"","none"===T(c,"display")){b=c.style;c=c.tagName;if(Ka[c])c=Ka[c];else{var d=p(c);e.body.insertBefore(d,null);var f=T(d,"display");e.body.removeChild(d);c=Ka[c]="none"!==f?f:"block"}b.display=c}}else c.___cd=T(c,"display"),c.style.display="none"})};I.hide=function(){return this.toggle(!1)};I.show=function(){return this.toggle(!0)};
function La(a,b){return!b||!z.call(b,function(c){return 0>a.indexOf(c)})}var W={focus:"focusin",blur:"focusout"},X={mouseenter:"mouseover",mouseleave:"mouseout"},Ma=/^(mouse|pointer|contextmenu|drag|drop|click|dblclick)/i;function Na(a,b,c,d,f){var g=a.___ce=a.___ce||{};g[b]=g[b]||[];g[b].push([c,d,f]);a.addEventListener(b,f)}function Oa(a){a=a.split(".");return[a[0],a.slice(1).sort()]}
function Y(a,b,c,d,f){var g=a.___ce=a.___ce||{};if(b)g[b]&&(g[b]=g[b].filter(function(h){var m=h[0],l=h[1];h=h[2];if(f&&h.guid!==f.guid||!La(m,c)||d&&d!==l)return!0;a.removeEventListener(b,h)}));else for(b in g)Y(a,b,c,d,f)}
I.off=function(a,b,c){var d=this;if(void 0===a)this.each(function(g,h){(C(h)||B(h)||L(h))&&Y(h)});else if(G(a))H(b)&&(c=b,b=""),M(Q(a),function(g,h){g=Oa(h);h=g[0];var m=g[1],l=X[h]||W[h]||h;d.each(function(u,w){(C(w)||B(w)||L(w))&&Y(w,l,m,b,c)})});else for(var f in a)this.off(f,a[f]);return this};
I.on=function(a,b,c,d,f){var g=this;if(!G(a)){for(var h in a)this.on(h,b,c,a[h],f);return this}G(b)||(void 0!==b&&null!==b&&(void 0!==c&&(d=c),c=b),b="");H(d)||(d=c,c=void 0);if(!d)return this;M(Q(a),function(m,l){m=Oa(l);l=m[0];var u=m[1],w=X[l]||W[l]||l,U=l in X,E=l in W;w&&g.each(function(t,n){if(C(n)||B(n)||L(n))t=function Sa(r){if(r.target["___i".concat(r.type)])return r.stopImmediatePropagation();if(!r.namespace||La(u,r.namespace.split(".")))if(b||!(E&&(r.target!==n||r.___ot===w)||U&&r.relatedTarget&&
n.contains(r.relatedTarget))){var fa=n;if(b){for(var F=r.target;!ua(F,b);){if(F===n)return;F=F.parentNode;if(!F)return}fa=F}Object.defineProperty(r,"currentTarget",{configurable:!0,get:function(){return fa}});Object.defineProperty(r,"delegateTarget",{configurable:!0,get:function(){return n}});Object.defineProperty(r,"data",{configurable:!0,get:function(){return c}});F=d.call(fa,r,r.___td);f&&Y(n,w,u,b,Sa);!1===F&&(r.preventDefault(),r.stopPropagation())}},t.guid=d.guid=d.guid||J.guid++,Na(n,w,u,b,
...
I.trigger=function(a,b){if(G(a)){var c=Oa(a),d=c[0];c=c[1];var f=X[d]||W[d]||d;if(!f)return this;var g=Ma.test(f)?"MouseEvents":"HTMLEvents";a=e.createEvent(g);a.initEvent(f,!0,!0);a.namespace=c.join(".");a.___ot=d}a.___td=b;var h=a.___ot in W;return this.each(function(m,l){h&&H(l[a.___ot])&&(l["___i".concat(a.type)]=!0,l[a.___ot](),l["___i".concat(a.type)]=!1);l.dispatchEvent(a)})};
function Pa(a){return a.multiple&&a.options?R(y.call(a.options,function(b){return b.selected&&!b.disabled&&!b.parentNode.disabled}),"value"):a.value||""}var Qa=/%20/g,Ra=/\r?\n/g,Ta=/file|reset|submit|button|image/i,Ua=/radio|checkbox/i;
I.serialize=function(){var a="";this.each(function(b,c){M(c.elements||[c],function(d,f){f.disabled||!f.name||"FIELDSET"===f.tagName||Ta.test(f.type)||Ua.test(f.type)&&!f.checked||(d=Pa(f),void 0!==d&&(d=v(d)?d:[d],M(d,function(g,h){g=a;h="&".concat(encodeURIComponent(f.name),"=").concat(encodeURIComponent(h.replace(Ra,"\r\n")).replace(Qa,"+"));a=g+h})))})});return a.slice(1)};
I.val=function(a){return arguments.length?this.each(function(b,c){if((b=c.multiple&&c.options)||Ua.test(c.type)){var d=v(a)?ka.call(a,String):null===a?[]:[String(a)];b?M(c.options,function(f,g){g.selected=0<=d.indexOf(g.value)},!0):c.checked=0<=d.indexOf(c.value)}else c.value=void 0===a||null===a?"":a}):this[0]&&Pa(this[0])};I.clone=function(){return this.map(function(a,b){return b.cloneNode(!0)})};I.detach=function(a){P(this,a).each(function(b,c){c.parentNode&&c.parentNode.removeChild(c)});return this};
var Va=/^\s*<(\w+)[^>]*>/,Wa=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,Xa={"*":da,tr:ea,td:ha,th:ha,thead:q,tbody:q,tfoot:q};function sa(a){if(!G(a))return[];if(Wa.test(a))return[p(RegExp.$1)];var b=Va.test(a)&&RegExp.$1;b=Xa[b]||Xa["*"];b.innerHTML=a;return J(b.childNodes).detach().get()}J.parseHTML=sa;I.empty=function(){return this.each(function(a,b){for(;b.firstChild;)b.removeChild(b.firstChild)})};
