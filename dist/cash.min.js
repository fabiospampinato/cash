...
(function(){
'use strict';var e=document,h=window,k=Array.prototype,l=k.filter,n=k.indexOf,p=k.map,q=k.push,r=k.slice,t=/^#[\w-]*$/,u=/^\.[\w-]*$/,v=/<.+>/,aa=/^\w+$/;function w(a,b){if(a){if(a.__cash)return a;var c=a;if(x(a)){if(c=t.test(a)?e.getElementById(a.slice(1)):v.test(a)?y(a):z(a,b),!c)return}else if(A(a))return this.ready(a);if(c.nodeType||c===h)c=[c];this.length=c.length;a=0;for(b=this.length;a<b;a++)this[a]=c[a]}}h.cash=h.$=function(a,b){return new w(a,b)};
...
function z(a,b){void 0===b&&(b=e);return u.test(a)?b.getElementsByClassName(a.slice(1)):aa.test(a)?b.getElementsByTagName(a):b.querySelectorAll(a)}var F=1;cash.guid=F;function G(a,b){var c=a&&(a.matches||a.webkitMatchesSelector||a.mozMatchesSelector||a.msMatchesSelector||a.oMatchesSelector);return!!c&&c.call(a,b)}cash.matches=G;var H;
...
B.removeAttr=function(a){return this.each(function(b,c){c.removeAttribute(a)})};B.removeProp=function(a){return this.each(function(b,c){delete c[a]})};B.toggleClass=function(a,b){var c=L(a),d=void 0!==b;return c.length?this.each(function(a,g){E(c,function(a){d?b?g.classList.add(a):g.classList.remove(a):g.classList.toggle(a)})}):this};B.addClass=function(a){return this.toggleClass(a,!0)};B.removeClass=function(a){return arguments.length?this.toggleClass(a,!1):this.attr("class","")};
B.get=function(a){return void 0===a?r.call(this):this[0>a?a+this.length:a]};B.eq=function(a){return cash(this.get(a))};B.filter=function(a){if(!a)return cash();var b=A(a)?a:K(a);return cash(l.call(this,function(c,d){return b.call(c,d,c,a)}))};B.first=function(){return this.eq(0)};B.last=function(){return this.eq(-1)};B.map=function(a){return cash(p.call(this,function(b,c){return a.call(b,c,b)}))};B.slice=function(){return cash(r.apply(this,arguments))};
...
B.on=function(a,b,c,d){var f=this;if(!x(a)){for(var g in a)this.on(g,b,a[g]);return this}A(b)&&(c=b,b=!1);E(L(a),function(a){a=V(a);var g=a[0],D=a[1];f.each(function(a,f){a=function la(a){if(!a.namespace||U(D,a.namespace.split("."))){var m=f;if(b)for(m=a.target;!G(m,b);){if(m===f)return;m=m.parentNode;if(!m)return}a.namespace=a.namespace||"";c.call(m,a,a.data);d&&W(f,g,D,la)}};a.guid=c.guid=c.guid||F++;ka(f,g,D,a)})});return this};B.one=function(a,b,c){return this.on(a,b,c,!0)};
