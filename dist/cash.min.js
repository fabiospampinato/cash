...
function t(a,b){if(a){if(a.__cash)return a;var c=a;if(u(a)){if(c=ca.test(a)?e.getElementById(a.slice(1)):ea.test(a)?v(a):r(a,b),!c)return}else if(w(a))return this.ready(a);if(c.nodeType||c===g)c=[c];this.length=c.length;a=0;for(b=this.length;a<b;a++)this[a]=c[a]}}function x(a,b){return new t(a,b)}var y=x.fn=x.prototype=t.prototype={constructor:x,__cash:!0,length:0,splice:h.splice};y.get=function(a){return void 0===a?q.call(this):this[0>a?a+this.length:a]};y.eq=function(a){return x(this.get(a))};
