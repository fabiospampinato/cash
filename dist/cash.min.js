...
(function(){
'use strict';var e=document,g=window,h=Array.prototype,l=h.filter,m=h.indexOf,aa=h.map,n=h.push,q=h.reverse,r=h.slice,ba=/^#[\w-]*$/,ca=/^\.[\w-]*$/,da=/<.+>/,ea=/^\w+$/;function t(a,b){void 0===b&&(b=e);return ca.test(a)?b.getElementsByClassName(a.slice(1)):ea.test(a)?b.getElementsByTagName(a):b.querySelectorAll(a)}
function u(a,b){if(a){if(a.__cash)return a;var c=a;if(v(a)){if(c=ba.test(a)?e.getElementById(a.slice(1)):da.test(a)?w(a):t(a,b),!c)return}else if(x(a))return this.ready(a);if(c.nodeType||c===g)c=[c];this.length=c.length;a=0;for(b=this.length;a<b;a++)this[a]=c[a]}}function y(a,b){return new u(a,b)}var z=y.fn=y.prototype=u.prototype={constructor:y,__cash:!0,length:0,splice:h.splice};z.get=function(a){return void 0===a?r.call(this):this[0>a?a+this.length:a]};z.eq=function(a){return y(this.get(a))};
z.first=function(){return this.eq(0)};z.last=function(){return this.eq(-1)};z.map=function(a){return y(aa.call(this,function(b,c){return a.call(b,c,b)}))};z.slice=function(){return y(r.apply(this,arguments))};var fa=/(?:^\w|[A-Z]|\b\w)/g,ha=/[\s-_]+/g;function A(a){return a.replace(fa,function(a,c){return a[c?"toUpperCase":"toLowerCase"]()}).replace(ha,"")}y.camelCase=A;function B(a,b){for(var c=0,d=a.length;c<d&&!1!==b.call(a[c],a[c],c,a);c++);}y.each=B;
z.each=function(a){B(this,function(b,c){return a.call(b,c,b)});return this};z.removeProp=function(a){return this.each(function(b,c){delete c[a]})};g.cash=g.$=y;y.extend=z.extend=function(a){void 0===a&&(a=this);for(var b=arguments,c=b.length,d=2>c?0:1;d<c;d++)for(var f in b[d])a[f]=b[d][f];return a};var C=1;y.guid=C;function D(a,b){var c=a&&(a.matches||a.webkitMatchesSelector||a.mozMatchesSelector||a.msMatchesSelector||a.oMatchesSelector);return!!c&&c.call(a,b)}y.matches=D;
function x(a){return"function"===typeof a}y.isFunction=x;function v(a){return"string"===typeof a}y.isString=v;function E(a){return!isNaN(parseFloat(a))&&isFinite(a)}y.isNumeric=E;var F=Array.isArray;y.isArray=F;z.prop=function(a,b){if(a){if(v(a))return 2>arguments.length?this[0]&&this[0][a]:this.each(function(c,f){f[a]=b});for(var c in a)this.prop(c,a[c]);return this}};function G(a){return v(a)?function(b,c){return D(c,a)}:a.__cash?function(b,c){return a.is(c)}:function(a,c,d){return c===d}}
z.filter=function(a){if(!a)return y();var b=x(a)?a:G(a);return y(l.call(this,function(c,d){return b.call(c,d,c,a)}))};var ia=/\S+/g;function I(a){return v(a)?a.match(ia)||[]:[]}z.hasClass=function(a){var b=I(a),c=!1;b.length&&this.each(function(a,f){c=f.classList.contains(b[0]);return!c});return c};z.removeAttr=function(a){var b=I(a);return b.length?this.each(function(a,d){B(b,function(a){d.removeAttribute(a)})}):this};
...
function T(a,b){return M(a,"border"+(b?"Left":"Top")+"Width")+M(a,"padding"+(b?"Left":"Top"))+M(a,"padding"+(b?"Right":"Bottom"))+M(a,"border"+(b?"Right":"Bottom")+"Width")}B(["Width","Height"],function(a){z["inner"+a]=function(){if(this[0])return this[0]===g?g["inner"+a]:this[0]["client"+a]}});
B(["width","height"],function(a,b){z[a]=function(c){if(!this[0])return void 0===c?void 0:this;if(!arguments.length)return this[0]===g?this[0][A("outer-"+a)]:this[0].getBoundingClientRect()[a]-T(this[0],!b);c=parseInt(c,10);return this.each(function(d,f){1===f.nodeType&&(d=L(f,"boxSizing"),f.style[a]=Q(a,c+("border-box"===d?T(f,!b):0)))})}});
B(["Width","Height"],function(a,b){z["outer"+a]=function(c){if(this[0])return this[0]===g?g["outer"+a]:this[0]["offset"+a]+(c?M(this[0],"margin"+(b?"Top":"Left"))+M(this[0],"margin"+(b?"Bottom":"Right")):0)}});function U(a,b){for(var c=0,d=b.length;c<d;c++)if(0>a.indexOf(b[c]))return!1;return!0}function na(a,b,c){B(a[c],function(a){b.removeEventListener(c,a[1])});delete a[c]}
function oa(a,b,c,d){d.guid=d.guid||C++;var f=a.__cashEvents=a.__cashEvents||{};f[b]=f[b]||[];f[b].push([c,d]);a.addEventListener(b,d)}function V(a){a=a.split(".");return[a[0],a.slice(1).sort()]}function W(a,b,c,d){var f=a.__cashEvents=a.__cashEvents||{};if(b){var k=f[b];k&&(d&&(d.guid=d.guid||C++),f[b]=k.filter(function(f){var k=f[0];f=f[1];if(d&&f.guid!==d.guid||!U(k,c))return!0;a.removeEventListener(b,f)}))}else if(c&&c.length)for(b in f)W(a,b,c,d);else for(b in f)na(f,a,b)}
z.off=function(a,b){var c=this;void 0===a?this.each(function(a,b){return W(b)}):B(I(a),function(a){a=V(a);var d=a[0],k=a[1];c.each(function(a,c){return W(c,d,k,b)})});return this};
z.on=function(a,b,c,d){var f=this;if(!v(a)){for(var k in a)this.on(k,b,a[k]);return this}x(b)&&(c=b,b=!1);B(I(a),function(a){a=V(a);var k=a[0],H=a[1];f.each(function(a,f){a=function pa(a){if(!a.namespace||U(H,a.namespace.split("."))){var p=f;if(b)for(p=a.target;!D(p,b);){if(p===f)return;p=p.parentNode;if(!p)return}a.namespace=a.namespace||"";p=c.call(p,a,a.data);d&&W(f,k,H,pa);!1===p&&(a.preventDefault(),a.stopPropagation())}};a.guid=c.guid=c.guid||C++;oa(f,k,H,a)})});return this};
...
z.offset=function(){var a=this[0];if(a)return a=a.getBoundingClientRect(),{top:a.top+g.pageYOffset-Z.clientTop,left:a.left+g.pageXOffset-Z.clientLeft}};z.offsetParent=function(){return y(this[0]&&this[0].offsetParent)};z.position=function(){var a=this[0];if(a)return{left:a.offsetLeft,top:a.offsetTop}};z.children=function(a){var b=[];this.each(function(a,d){n.apply(b,d.children)});b=y(K(b));return a?b.filter(function(b,d){return D(d,a)}):b};
z.contents=function(){var a=[];this.each(function(b,c){n.apply(a,"IFRAME"===c.tagName?[c.contentDocument]:c.childNodes)});return y(a.length&&K(a))};z.find=function(a){for(var b=[],c=0,d=this.length;c<d;c++){var f=t(a,this[c]);f.length&&n.apply(b,f)}return y(b.length&&K(b))};z.has=function(a){var b=v(a)?function(b,d){return!!t(a,d).length}:function(b,d){return d.contains(a)};return this.filter(b)};
z.is=function(a){if(!a||!this[0])return!1;var b=G(a),c=!1;this.each(function(d,f){c=b(d,f,a);return!c});return c};z.next=function(){return y(this[0]&&this[0].nextElementSibling)};z.not=function(a){if(!a||!this[0])return this;var b=G(a);return this.filter(function(c,d){return!b(c,d,a)})};z.parent=function(){var a=[];this.each(function(b,c){c&&c.parentNode&&a.push(c.parentNode)});return y(K(a))};z.index=function(a){var b=a?y(a)[0]:this[0];a=a?this:y(b).parent().children();return m.call(a,b)};
z.closest=function(a){return a&&this[0]?this.is(a)?this.filter(a):this.parent().closest(a):y()};z.parents=function(a){var b=[],c;this.each(function(d,f){for(c=f;c&&c.parentNode&&c!==e.body.parentNode;)c=c.parentNode,(!a||a&&D(c,a))&&b.push(c)});return y(K(b))};z.prev=function(){return y(this[0]&&this[0].previousElementSibling)};z.siblings=function(){var a=this[0];return this.parent().children().filter(function(b,c){return c!==a})};
})();